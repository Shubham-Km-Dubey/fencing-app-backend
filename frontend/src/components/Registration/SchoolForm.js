...
const SchoolForm = ({ user, registrationData, onCompleteRegistration }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/school/register', submissionData);
          ...
          <>
            ...
            <section className="form-section">
              ...
              <div className="payment-notice">
                <h3>Registration Fee: ₹1000</h3>
                <p>Complete your school registration by making the payment. Your registration will be processed after successful payment.</p>
