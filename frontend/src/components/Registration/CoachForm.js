...
const CoachForm = ({ user, registrationData, onCompleteRegistration }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/coach/register', submissionData);
                  ...
                  <div className="document-item">
                    ...
                    <div className="file-upload-container">
                      <div 
                        ...
                        onDragOver={handleDragOver}
                        onDragLeave={handleDragLeave}
                        onDrop={(e) => handleDrop(e, 'coachCertificate')}
                      >
                        <input
                          type="file"
                          accept=".pdf"
                          onChange={(e) => handleFileChange(e, 'coachCertificate')}
                          className="file-input"
                        />
                        <div className="upload-content">
                          <i className="fas fa-file-certificate"></i>
                          <div className="upload-text">
                            {formData.documents.coachCertificate ? (
                              <div className="file-success">
                                <i className="fas fa-check-circle"></i>
                      ...
                      {uploadProgress.coachCertificate !== null && uploadProgress.coachCertificate !== undefined && (
                        <div className="upload-progress">
                          <div className="progress-info">
                            <span>Uploading: {uploadProgress.coachCertificate}%</span>
                          </div>
                          <div className="progress-bar-container">
                            <div 
                              className="progress-bar" 
                              style={{ width: `${uploadProgress.coachCertificate}%` }}
                            ></div>
                          </div>
                        </div>
                      )}
