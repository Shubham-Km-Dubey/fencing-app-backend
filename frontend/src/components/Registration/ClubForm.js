    ...
    try {
      ...
      if (!user) {
        ...
        const userRegistrationData = {
          ...
          districtShortcode,
          phone: formData.clubContactNumber || '9999999999'
        };
      ...
      if (paymentSession.success) {
        ...
        const checkoutOptions = {
          ...
          returnUrl: `${window.location.origin}/payment-success?order_id=${paymentSession.data.order_id}&user_type=club`,
